...
vi.mock('@/components/admin/dashboard/AdminLoyaltyV2', () => ({
  AdminLoyaltyV2: () => <div data-testid="v2">V2 loyalty</div>,
}))

vi.mock('@/components/admin/_v1/AdminLoyaltyV1', () => ({
  AdminLoyaltyV1: () => <div data-testid="v1">V1 loyalty</div>,
}))
...
describe('admin/loyalty/page dispatcher', () => {

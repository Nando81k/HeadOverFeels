          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              {pendingOrdersCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-yellow-500 text-white text-xs font-bold px-2 py-1 rounded-full min-w-6 text-center shadow-lg">
                  {pendingOrdersCount}
                </span>
              )}
              <div className="flex items-center justify-between mb-4">
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Loyalty Program</h3>
              <p className="text-sm text-gray-600">Rewards & tiers</p>
            </Link>
          </div>
        </div>

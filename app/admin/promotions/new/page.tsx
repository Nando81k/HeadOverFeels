  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-[#FF3131]/20 rounded-lg">
              <Tag weight="bold" className="w-5 h-5 text-[#FF3131]" />
            </div>
            <div>
              <p className="text-[10px] font-medium text-white/40 uppercase tracking-[0.15em]">Type</p>
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-emerald-500/20 rounded-lg">
              <Percent weight="bold" className="w-5 h-5 text-emerald-400" />
            </div>
            <div>
              <p className="text-[10px] font-medium text-white/40 uppercase tracking-[0.15em]">Value</p>
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-blue-500/20 rounded-lg">
              <Hash weight="bold" className="w-5 h-5 text-blue-400" />
            </div>
            <div>
              <p className="text-[10px] font-medium text-white/40 uppercase tracking-[0.15em]">Code</p>
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4">
          <div className="flex items-center gap-3">
            <div className={`p-2 rounded-lg ${formData.isActive ? 'bg-emerald-500/20' : 'bg-white/10'}`}>
              <Lightning weight="bold" className={`w-5 h-5 ${formData.isActive ? 'text-emerald-400' : 'text-white/40'}`} />
            </div>
            <div>
              <p className="text-[10px] font-medium text-white/40 uppercase tracking-[0.15em]">Status</p>
              <p className={`text-lg font-bold ${formData.isActive ? 'text-emerald-400' : 'text-white/40'}`}>
            ...
            <div className="px-5 pb-5 grid gap-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-white/30 focus:outline-none focus:border-[#FF3131]/50 focus:ring-1 focus:ring-[#FF3131]/20 transition-colors resize-none"
                />
              </div>
            </div>
          )}
              ...
              <div className="grid grid-cols-2 gap-3">
                {typeOptions.map(option => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <Icon size={24} weight={isSelected ? 'fill' : 'regular'} className={isSelected ? 'text-[#FF3131]' : ''} />
                        <div>
          ...
          {!collapsedSections.has('code') && (
            <div className="px-5 pb-5">
              <label className="flex items-center gap-3 mb-4 cursor-pointer group">
                <div className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${formData.autoApply ? 'bg-[#FF3131] border-[#FF3131]' : 'bg-white/5 border-white/20 group-hover:border-white/40'}`}>
                ...
                <div className="flex gap-3">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white font-mono placeholder:text-white/30 focus:outline-none focus:border-[#FF3131]/50 focus:ring-1 focus:ring-[#FF3131]/20 transition-colors uppercase"
                    />
                  </div>
                  <button
                    type="button"
                    onClick={generateCode}
                    className="self-end px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white/70 hover:bg-white/10 hover:text-white transition-colors"
                  >
                    Generate
                  </button>
                </div>
            ...
            <div className="px-5 pb-5">
              ...
              <div className="mt-4 space-y-3">
                <label className="flex items-center gap-3 cursor-pointer group">
                  <div className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${formData.excludeSaleItems ? 'bg-[#FF3131] border-[#FF3131]' : 'bg-white/5 border-white/20 group-hover:border-white/40'}`}>
                ...
                <label className="flex items-center gap-3 cursor-pointer group">
                  <div className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${formData.firstTimeOnly ? 'bg-[#FF3131] border-[#FF3131]' : 'bg-white/5 border-white/20 group-hover:border-white/40'}`}>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#FF3131]/50 focus:ring-1 focus:ring-[#FF3131]/20 transition-colors min-h-[100px]"
                  >
                    {products.map(p => (
                      <option key={p.id} value={p.id} className="bg-zinc-900">{p.name}</option>
                    ))}
                  </select>
                  <p className="text-xs text-white/30 mt-1">Hold Ctrl/Cmd to select multiple</p>
                </div>
          ...
          {!collapsedSections.has('schedule') && (
            <div className="px-5 pb-5">
              ...
              <label className="flex items-center gap-3 mt-4 cursor-pointer group">
                <div className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${formData.isActive ? 'bg-[#FF3131] border-[#FF3131]' : 'bg-white/5 border-white/20 group-hover:border-white/40'}`}>
                ...
                />
                <div>
                  <p className="text-white/70">Active immediately</p>
                  <p className="text-xs text-white/40">Uncheck to create as draft</p>
                </div>
              </label>
            </div>
          )}

...
export default async function AdminLoyaltyPage({ searchParams }: PageProps) {
  ...
  // Resolve isSuperAdmin once at the server boundary so privileged Tab
  // components (Members/Tiers/Redemptions) can gate destructive affordances
  // without doing their own auth lookup.

    ...
    <div className="bg-neutral-900/60 border border-white/8 rounded-md p-4 flex items-start gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="mt-2 grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs text-white/60">
          ...
          <div>
            <span className="text-white/80">{nFmt.format(header.currentPoints)}</span> pts
          </div>
          <div>
            <span className="text-white/80">{nFmt.format(header.lifetimePoints)}</span> lifetime
          </div>
          <div>
            <span className="text-white/80">{nFmt.format(header.totalOrders)}</span> orders
          </div>
        </div>
      </div>
